...
void PlayerSidewaysStairsToRight(u8 a);
void PlayerSidewaysStairsToLeft(u8 a);
void PlayerSidewaysStairsToRightRunning(u8 a);
void PlayerSidewaysStairsToLeftRunning(u8 a);
